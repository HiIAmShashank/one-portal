        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg bg-primary/5 border border-primary/20 p-4">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              ...
              <li>
                ✅ <strong>Smaller bundles</strong> - Remote apps don't
                duplicate Tailwind
              </li>
              <li>
                ✅ <strong>Consistent theming</strong> - Single source of truth
                for design tokens
              </li>
              <li>
                ✅ <strong>Faster builds</strong> - Apps don't need to compile
                CSS individually
              </li>
              <li>
                ✅ <strong>Easy updates</strong> - Change theme in one place,
                apply everywhere
              </li>
            </ul>
          </div>
