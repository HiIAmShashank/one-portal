import {
  require_test
} from "./chunk-VGX5CKRE.js";
import {
  require_global,
  require_preview_errors
} from "./chunk-RDCFRN63.js";
import {
  require_preview_api
} from "./chunk-T6KG3DAI.js";
import {
  __toESM
} from "./chunk-MTI3AIJG.js";

// ../../node_modules/.pnpm/@storybook+addon-a11y@9.1.13_storybook@9.1.13_@testing-library+dom@10.4.0_prettier@3.6._163936a2e03926dd8e8fc985a7b94f07/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  var _a;
  let axe = ((_a = await import("./axe-PPBXRFBO.js")) == null ? void 0 : _a.default) || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-3HTSPRNN.js");
