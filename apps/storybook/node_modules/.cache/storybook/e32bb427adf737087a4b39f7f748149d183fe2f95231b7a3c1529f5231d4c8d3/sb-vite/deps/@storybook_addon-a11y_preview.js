import {
  require_test
} from "./chunk-7WTNKMQD.js";
import {
  require_global,
  require_preview_errors
} from "./chunk-LAFDAVDF.js";
import {
  require_preview_api
} from "./chunk-325WRNOV.js";
import {
  __toESM
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  var _a;
  let axe = ((_a = await import("./axe-H7ZDBT3L.js")) == null ? void 0 : _a.default) || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-576VATKJ.js");
