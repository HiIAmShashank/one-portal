...
import {
  ...
  wt,
  xP
} from "./chunk-3JSWAN7S.js";
import "./chunk-5FGFB2M3.js";
import "./chunk-KJJT3LQZ.js";
import "./chunk-BQ6BAADA.js";
import "./chunk-PG67ZSQK.js";
import {
  z
} from "./chunk-6CF7TVE4.js";
import {
  gt,
  yn
} from "./chunk-CBP63RNI.js";
...
import "./chunk-LZ3XCEQE.js";
import {
  require_core_events
} from "./chunk-3T3HEUF2.js";
import {
  dedent
} from "./chunk-B27WUNEA.js";
import {
  require_preview_api
...
// ../../node_modules/.pnpm/@storybook+addon-docs@8.6.14_@types+react@19.2.2_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@8.6.14_react-dom@19.2.0_react@19.2.0__react@19.2.0_storybook@8.6.14_prettier@3.6.2_/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-WBPOPX3O.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-Z4QA3QOY.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-JYXMCAAZ.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-ZMSKGO2W.js.map
