...
export const mount: MountFunction = (containerId: string) => {
  ...
  if (!container) {
    throw new Error(`[Analytics Dashboard] Container element with ID "${containerId}" not found`);
  }

  console.log(`[Analytics Dashboard] Mounting into container: ${containerId}`);
...
export const unmount: UnmountFunction = () => {
  console.log('[Analytics Dashboard] Unmounting application');
